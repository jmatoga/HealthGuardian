...
public class DoctorListOfClinicsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        DoctorListOfClinicsController.ReadFromServer = Client.ReadFromServer;
        DoctorListOfClinicsController.SendToServer = Client.SendToServer;
