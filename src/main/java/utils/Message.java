...
public class Message {
    ...
    public void checkIfUserExists(PrintWriter writer, String message) {
        writer.println("CHECK_IF_USER_EXISTS:" + message);
    }

    public void checkIfDoctorExists(PrintWriter writer, String message) {
        writer.println("CHECK_IF_DOCTOR_EXISTS:" + message);
    }
